...
plot(dat2$MONTHS_SINCE_BEG, dat2$pool.elevation, type =  "l", lty = 1, lwd = 1.5,
     xlab = "time since beginning (months)", ylab = "Pool Elevation", ylim = c(3400, 3750), main="RF Prediction on Current Data")
...
plot(dat2$MONTHS_SINCE_BEG, dat2$pool.elevation, type =  "l", lty = 1, lwd = 1.5,
     ...
     xlim = c(200, max(as.numeric(rownames(all_fcasts$total.inflows)))), main="RF Forecast")
...
plot(dat2$MONTHS_SINCE_BEG, dat2$pool.elevation, type =  "l", lty = 1, lwd = 1.5,
     xlab = "time since beginning (months)", ylab = "Pool Elevation", ylim = c(3400, 3750), main="KNN Prediction on Current Data")
lines(test_dat$MONTHS_SINCE_BEG, predictions, col = "red", lwd = 3)
abline(h = 3490, col = "blue")
```
```{r}
...
plot(dat2$MONTHS_SINCE_BEG, dat2$pool.elevation, type =  "l", lty = 1, lwd = 1.5,
     xlab = "time since beginning (months)", ylab = "Pool Elevation", ylim = c(3400, 3750), xlim = c(200, 1000), main= "KNN Forecast")
lines(as.numeric(names(all_predictions)), all_predictions, col = "red", lwd = 3)
abline(h = 3490, col = "blue")
```
...
plot(dat2$MONTHS_SINCE_BEG, dat2$pool.elevation, type =  "l", lty = 1, lwd = 1.5,
     xlab = "time since beginning (months)", ylab = "Pool Elevation", ylim = c(3400, 3750), main="Lasso Prediction on Current Data")
lines(test_dat$MONTHS_SINCE_BEG, predictions, col = "red", lwd = 3)
abline(h = 3490, col = "blue")
...
plot(dat2$MONTHS_SINCE_BEG, dat2$pool.elevation, type =  "l", lty = 1, lwd = 1.5,
     xlab = "time since beginning (months)", ylab = "Pool Elevation", ylim = c(3400, 3750), xlim = c(200, max(as.numeric(rownames(all_fcasts$total.inflows)))), main="Lasso Forecast")+points(x=1328, y=3490)
lines(as.numeric(names(all_predictions)), all_predictions, col = "red", lwd = 3)
abline(h = 3490, col = "blue")
```
