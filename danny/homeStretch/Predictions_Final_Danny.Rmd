...
# rf_gridsearch<- randomForest(pool.elevation ~ MONTHS_SINCE_BEG + total.inflows + total.release + evaporation + power.release, data = train_dat, mtry = 3, importance = TRUE, na.action = na.omit)
print(rf_gridsearch)
